  ...
  return (
    <div className="currency-converter">
      ...
      <p className="description">
        Welcome! This JavaScript-based app allows you to convert an amount from one currency to another.
        It fetches live exchange rates using a free API, so you always get up-to-date values.
        Simply enter the amount, select the source and target currencies, and click "Convert".
      </p>
